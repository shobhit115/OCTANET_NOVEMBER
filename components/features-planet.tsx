      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            ...
            What is Codex Club? Why Codex Club?
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              Engage in real-time coding with fellow developers during our interactive live sessions. Solve problems together, learn new techniques, and sharpen your coding skills in an energetic and supportive environment.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Take on weekly coding challenges that test your problem-solving abilities and help you apply the skills you’ve learned. Whether you’re a beginner or expert, there’s always a challenge to help you grow.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Connect with industry experts who can guide you through your learning journey. Get personalized feedback, career advice, and support to help you overcome obstacles and achieve your goals.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Test your skills and collaborate with other members in hackathons. Compete to solve real-world problems, create projects, and learn new tools while building connections with fellow developers.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              We bring together passionate learners and experienced professionals to help each other grow, share knowledge, and collaborate on projects.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              We provide access to up-to-date tutorials, workshops, and resources that cover the latest tools, technologies, and best practices in software development.
              </p>
            </article>
          </div>
